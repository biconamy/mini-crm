...
from mini_crm.cli import main
from mini_crm.models import Note, ProjectState, Task
from mini_crm.cli import demo_state
from mini_crm.storage import load_state, save_state
from mini_crm.models import generate_short_id
from mini_crm.validation import normalize_tags, require_text, validate_task_status
from mini_crm.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
